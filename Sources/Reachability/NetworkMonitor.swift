...
public final class NetworkMonitor: @unchecked Sendable {
  ...
  public init(shouldDetectVpnAutomatically: Bool = true, queue: DispatchQueue? = nil) {
    self.monitor = NWPathMonitor()
    self.monitorQueue = queue ?? DispatchQueue(label: "com.networkmanager.networkmonitor.queue", qos: .userInitiated)
